...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_route53"></a> [route53](#module\_route53) | ../terraform-aws-route53 | n/a |
...
| <a name="input_controller_pod_annotations"></a> [controller\_pod\_annotations](#input\_controller\_pod\_annotations) | Annotations added to the argocd-application-controller pod template, e.g. Datadog autodiscovery `ad.datadoghq.com/*` keys for scraping controller metrics. | `map(string)` | `{}` | no |

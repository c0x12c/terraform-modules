...
module "datadog_gcp_integration" {
  source  = "terraform.c0x12c.com/c0x12c/gcp-integration/datadog"
  version = "1.1.0"
...
| <a name="requirement_datadog"></a> [datadog](#requirement\_datadog) | >= 3.46, < 3.80 |
...
| Name | Version |
|------|---------|
| <a name="provider_datadog"></a> [datadog](#provider\_datadog) | >= 3.46, < 3.80 |
...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_service_account"></a> [service\_account](#module\_service\_account) | ../terraform-gcp-service-account | n/a |
...
| <a name="input_enabled_services"></a> [enabled\_services](#input\_enabled\_services) | Values to enable GCP services in Datadog integration. | `list(string)` | <pre>[<br/>  "redis",<br/>  "memcache",<br/>  "memorystore",<br/>  "cloudsql",<br/>  "dbinsights",<br/>  "kubernetes",<br/>  "loadbalancing"<br/>]</pre> | no |

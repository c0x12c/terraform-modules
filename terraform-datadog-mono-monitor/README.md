...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_http_check"></a> [http\_check](#module\_http\_check) | ../terraform-datadog-monitors | n/a |
...
| <a name="input_namespace_regex"></a> [namespace\_regex](#input\_namespace\_regex) | Whether to specific the namespace of service that is belong to | `string` | `"*"` | no |

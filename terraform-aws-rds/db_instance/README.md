...
| <a name="input_engine_version"></a> [engine\_version](#input\_engine\_version) | The version of Postgres database, default 18.4. | `string` | `"18.4"` | no |
...
| <a name="input_manage_master_user_password"></a> [manage\_master\_user\_password](#input\_manage\_master\_user\_password) | Let AWS manage and rotate the master password in Secrets Manager. | `bool` | `false` | no |
| <a name="input_master_user_secret_kms_key_id"></a> [master\_user\_secret\_kms\_key\_id](#input\_master\_user\_secret\_kms\_key\_id) | KMS key for the AWS-managed master user secret; null uses the AWS-managed key. | `string` | `null` | no |
...
| <a name="output_master_user_secret_arn"></a> [master\_user\_secret\_arn](#output\_master\_user\_secret\_arn) | ARN of the AWS-managed master user secret, or null when Terraform owns the password |
<!-- END_TF_DOCS -->
...
```hcl
module "openvpn" {
  source  = "terraform.c0x12c.com/c0x12c/openvpn/aws"
  version = "0.5.0"
...
| <a name="output_ovpn_file"></a> [ovpn\_file](#output\_ovpn\_file) | OpenVPN client profile (.ovpn) for connecting to this server. |

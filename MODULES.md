...
| `terraform-aws-health-notification` | `terraform.c0x12c.com/c0x12c/health-notification/aws` | 0.2.1 | Delivers AWS Health Dashboard events to Slack, email, or any SNS subscriber. |
...
| `terraform-datadog-logging-monitor` | `terraform.c0x12c.com/c0x12c/logging-monitor/datadog` | 0.0.2 | <!-- BEGIN_TF_DOCS --> |

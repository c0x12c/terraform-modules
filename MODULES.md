...
116 modules, published to `terraform.c0x12c.com`. Consume any module with:
...
| `terraform-aws-health-notification` | `terraform.c0x12c.com/c0x12c/health-notification/aws` | 0.4.0 | Delivers AWS Health Dashboard events to Slack, email, or any SNS subscriber. |
...
| `terraform-aws-ses-monitoring` | `terraform.c0x12c.com/c0x12c/ses-monitoring/aws` | 1.0.0 |  |
...
| `terraform-aws-static-website` | `terraform.c0x12c.com/c0x12c/static-website/aws` | 1.2.0 | Module which create a static website on AWS. |
...
| `terraform-datadog-logging-monitor` | `terraform.c0x12c.com/c0x12c/logging-monitor/datadog` | 0.0.2 |  |
| `terraform-datadog-monitors` | `terraform.c0x12c.com/c0x12c/monitors/datadog` | 1.0.1 |  |
...
| `terraform-datadog-service-monitor` | `terraform.c0x12c.com/c0x12c/service-monitor/datadog` | 1.1.4 | Terraform module which creates Datadog monitors for services, supporting: |
...
| `terraform-gcp-google-workspace` | `terraform.c0x12c.com/c0x12c/google-workspace/gcp` | 1.0.0 | This Terraform module provisions workspace group resources that manages workspace members. |
...
| `terraform-gcp-service-account` | `terraform.c0x12c.com/c0x12c/service-account/gcp` | 1.0.0 | This Terraform module creates a GCP Service Account. |
...
| `terraform-qdrant-accounts-cluster` | `terraform.c0x12c.com/c0x12c/accounts-cluster/qdrant` | 1.0.0 |  |
